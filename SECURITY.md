...
You can expect an acknowledgement within a few days. Please include reproduction steps and the affected package or tool (`@yesid/tokens`, `@yesid/motion`, `@yesid/gates`, `@yesid/seo-kit`, `@yesid/ui`, `@yesid/analytics`, `@yesid/i18n-core`, `tools/adopt.ts`).
