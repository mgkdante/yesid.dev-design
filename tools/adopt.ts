...
function usage(): string {
	return [
		'Usage:',
		'  bun tools/adopt.ts --tag vX.Y.Z --packages tokens,motion,gates,seo-kit,ui,analytics,i18n-core --dest vendor/design',
		'  bun tools/adopt.ts --tag vX.Y.Z --packages tokens,motion,gates,seo-kit,ui,analytics,i18n-core --dest vendor/design --source ../yesid.dev-design',
		'  bun tools/adopt.ts --tag vX.Y.Z --packages tokens,motion,gates,seo-kit,ui,analytics,i18n-core --dest vendor/design --archive ./yesid.dev-design-vX.Y.Z.tar',
