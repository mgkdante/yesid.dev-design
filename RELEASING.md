...
- The root and `@yesid/tokens`, `@yesid/motion`, `@yesid/gates`, `@yesid/seo-kit`, `@yesid/ui`, `@yesid/analytics`, and `@yesid/i18n-core`
...
synchronizes the root manifest, seven released package manifests, and lockfile.
...
`@yesid/config` does not share the coordinated `v*` version or adoption asset.
